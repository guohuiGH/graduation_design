...
x_train, y_train = reader.read_train_data('../UCR_TS_Archive_2015/' + name + "/" + name + "_TRAIN2")
x_test, y_test = reader.read_test_data("../UCR_TS_Archive_2015/" + name + "/" + name + "_TEST2")
x_input, y_input = reader.temp_read_test_data("../UCR_TS_Archive_2015/" + name + "/" + name + "_TEST2")
