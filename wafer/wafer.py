...
class InputLibsvm:
    def __init__(self):
        ...
        name ="wafer" + "/" + "wafer"
        self.x_train, self.y_train = reader.read_train_data('../UCR_TS_Archive_2015/'+name+"_TRAIN2")

        self.x_test, self.y_test = reader.read_test_data("../UCR_TS_Archive_2015/"+name+"_TEST2")
        self.x_input, self.y_input = reader.temp_read_test_data("../UCR_TS_Archive_2015/"+name+"_TEST2")
...
class LstmParam:
    def __init__(self,dataset):
        ...
        # Network Parameters
        self.n_input = 1 # feature number
        self.n_steps = 152
        self.n_hidden = 60 # hidden layer num of features
        ...
        self.f_input = 1 # input feature number
